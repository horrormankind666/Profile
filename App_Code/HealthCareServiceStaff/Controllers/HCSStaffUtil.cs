...
public class HCSStaffUtil
{
    ...
    public static Dictionary<string, object> GetInfoLogin(string _page, string _id)
    {
        ...
        {
            if (_page.Equals(PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_EDIT))          _systemError = (!String.IsNullOrEmpty(_id) ? (HCSStaffDB.GetHCSHospital(_id).Tables[0].Rows.Count > 0 ? 0 : 4) : 4);
            if (_page.Equals(PAGE_MASTERDATAREGISTRATIONFORM_EDIT))                     _systemError = (!String.IsNullOrEmpty(_id) ? (HCSStaffDB.GetHCSRegistrationForm(_id).Tables[0].Rows.Count > 0 ? 0 : 4) : 4);
            if (_page.Equals(PAGE_MASTERDATAAGENCYREGISTERED_EDIT))                     _systemError = (!String.IsNullOrEmpty(_id) ? (HCSStaffDB.GetHCSAgencyRegistered(_id).Tables[0].Rows.Count > 0 ? 0 : 4) : 4);
            if (_page.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_EDIT))   _systemError = (!String.IsNullOrEmpty(_id) ? (Util.DBUtil.ChkUserStudentWithAuthenStaff(_username, _userlevel, _systemGroup, _id).Equals(0) ? 0 : 3) : 3);
            if (_page.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_EDIT))           _systemError = (!String.IsNullOrEmpty(_id) ? (Util.DBUtil.ChkUserStudentWithAuthenStaff(_username, _userlevel, _systemGroup, _id).Equals(0) ? 0 : 3) : 3);
            if (_page.Equals(PAGE_STUDENTRECORDSSTUDENTCV_MAIN))                        _systemError = (!String.IsNullOrEmpty(_id) ? (Util.DBUtil.ChkUserStudentWithAuthenStaff(_username, _userlevel, _systemGroup, _id).Equals(0) ? 0 : 3) : 3);
        }
    ...
    //ฟังก์ชั่นสำหรับตรวจสอบการเข้าถึงระบบในแต่ละส่วนตามระดับผู้ใช้งาน แล้วส่งค่ากลับเป็น bool
    //โดยมีพารามิเตอร์ดังนี้
    //1. _finServiceLogin   เป็น Dictionary<string, object> รับค่าชุดข้อมูลของผู้ใช้งาน
    ...
    public static bool ChkUserPermission(Dictionary<string, object> _finServiceLogin, string _page)
    {
        ...
        switch (_page)
        {
            ...
            case PAGE_MEANINGOFADMISSIONTYPE_MAIN                                                   : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_MEANINGOFSTUDENTSTATUS_MAIN                                                   : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_MEANINGOFHEALTHCARESERVICEFORM_MAIN                                           : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_MAIN                                    : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_NEW                                     : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_EDIT                                    : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAREGISTRATIONFORM_MAIN                                               : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAREGISTRATIONFORM_NEW                                                : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAREGISTRATIONFORM_EDIT                                               : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAAGENCYREGISTERED_MAIN                                               : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAAGENCYREGISTERED_NEW                                                : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_MASTERDATAAGENCYREGISTERED_EDIT                                               : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_STUDENTRECORDSSTUDENTCV_MAIN                                                  : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_DOWNLOADREGISTRATIONFORM_MAIN                                                 : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_DOWNLOADREGISTRATIONFORM_PROGRESS                                             : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESHEALTHINFORMATION_MAIN                                             : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESHEALTHINFORMATION_PROGRESS                                         : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORM_MAIN                       : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMVIEWCHART_MAIN              : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }            
            case PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMVIEWTABLE_MAIN              : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMLEVEL1VIEWTABLE_PROGRESS    : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMLEVEL2VIEWTABLE_PROGRESS    : { _access = (_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_USER) ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTSELECTHOSPITAL_DIALOG                         : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_MAIN                             : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_EDIT                             : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_PROGRESS                         : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_MAIN                                     : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_EDIT                                     : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
            case PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_PROGRESS                                 : { _access = ((_userlevel.Equals(FinServiceLogin.USERLEVEL_ADMIN) || _userlevel.Equals(FinServiceLogin.USERLEVEL_ADMINUSER) || _userlevel.Equals(FinServiceLogin.USERLEVEL_SUPERUSER)) && _faculty.Equals("MU-01") ? true : false); break; }
        }
    ...
    public static Dictionary<string, object> GetPage(string _page, string _id)
    {
            ...
            _page.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_MAIN))
        {
            ...
            if (_page.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_MAIN))   _sectionAction = SUBJECT_SECTION_TERMSERVICEHCSCONSENTREGISTRATION;
            if (_page.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_MAIN))           _sectionAction = SUBJECT_SECTION_TERMSERVICEHCSCONSENTOOCA;
    ...
    //ฟังก์ชั่นสำหรับแสดงฟอร์ม แล้วส่งค่ากลับเป็น Dictionary<string, object>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _form  เป็น string รับค่าชื่อฟอร์ม
    //2. _id    เป็น string รับค่ารหัสที่ต้องการ
    public static Dictionary<string, object> GetForm(string _form, string _id)
    {
        ...
        {            
            ...
            _width      = 855;
            _height     = 0;
            if (_form.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_PROGRESS))   _title = ("ส่งออก" + _submenu[7, 0]);
            if (_form.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_PROGRESS))           _title = ("ส่งออก" + _submenu[8, 0]);
        }
    ...
    //ฟังก์ชั่นสำหรับกำหนดเนื้อหาที่เป็นหัวข้อในแต่ละหน้า แล้วส่งค่ากลับเป็น Dictionary<string, object>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _page  เป็น string รับค่าชื่อหน้า 
    //2. _data  เป็น Dictionary<string, object> รับค่าข้อมูลอื่นที่ต้องการให้แสดง
    ...
    //ฟังก์ชั่นสำหรับกำหนดค่าที่ใช้ค้นหาข้อมูลจากคุ๊กกี้ แล้วส่งค่ากลับเป็น Dictionary<string, object>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _page  เป็น string รับค่าชื่อหน้า
    ...
    //ฟังก์ชั่นสำหรับกำหนดค่าที่เป็นเงื่อนไขในการค้นหาข้อมูล แล้วส่งค่ากลับเป็น Dictionary<string, object>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _page      เป็น string รับค่าชื่อหน้า
    //2. _c         เป็น HttpContext รับค่าข้อมูลจาก javascript ที่เรียกใช้งาน    
    //3. _setCookie เป็น bool รับค่าต้องการสร้างคุ๊กกี้หรือไม่
    public static Dictionary<string, object> SetParameterSearch(string _page, HttpContext _c, bool _setCookie)
    {
        ...
        if (_paramResult.ContainsKey("Keyword").Equals(true))           _valueCookie.AppendFormat("Keyword:{0},", _paramResult["Keyword"]);        
        if (_paramResult.ContainsKey("DegreeLevel").Equals(true))       _valueCookie.AppendFormat("DegreeLevel:{0},", _paramResult["DegreeLevel"]);
        if (_paramResult.ContainsKey("Faculty").Equals(true))           _valueCookie.AppendFormat("Faculty:{0},", _paramResult["Faculty"]);
        if (_paramResult.ContainsKey("Program").Equals(true))           _valueCookie.AppendFormat("Program:{0},", _paramResult["Program"]);
        if (_paramResult.ContainsKey("YearEntry").Equals(true))         _valueCookie.AppendFormat("YearEntry:{0},", _paramResult["YearEntry"]);
        if (_paramResult.ContainsKey("EntranceType").Equals(true))      _valueCookie.AppendFormat("EntranceType:{0},", _paramResult["EntranceType"]);
        if (_paramResult.ContainsKey("StudentStatus").Equals(true))     _valueCookie.AppendFormat("StudentStatus:{0},", _paramResult["StudentStatus"]);
        if (_paramResult.ContainsKey("CancelledStatus").Equals(true))   _valueCookie.AppendFormat("CancelledStatus:{0},", _paramResult["CancelledStatus"]);        
        if (_paramResult.ContainsKey("ForPublicServant").Equals(true))  _valueCookie.AppendFormat("ForPublicServant:{0},", _paramResult["ForPublicServant"]);        
        if (_paramResult.ContainsKey("Hospital").Equals(true))          _valueCookie.AppendFormat("Hospital:{0},", _paramResult["Hospital"]);
        if (_paramResult.ContainsKey("HCSJoin").Equals(true))           _valueCookie.AppendFormat("HCSJoin:{0},", _paramResult["HCSJoin"]);                
        if (_paramResult.ContainsKey("RegistrationForm").Equals(true))  _valueCookie.AppendFormat("RegistrationForm:{0},", _paramResult["RegistrationForm"]);                
        if (_paramResult.ContainsKey("DownloadStatus").Equals(true))    _valueCookie.AppendFormat("DownloadStatus:{0},", _paramResult["DownloadStatus"]);
        if (_paramResult.ContainsKey("TermServiceType").Equals(true))   _valueCookie.AppendFormat("TermServiceType:{0},", _paramResult["TermServiceType"]);
        if (_paramResult.ContainsKey("ConsentStatus").Equals(true))     _valueCookie.AppendFormat("ConsentStatus:{0},", _paramResult["ConsentStatus"]);
        if (_paramResult.ContainsKey("TermServiceNote").Equals(true))   _valueCookie.AppendFormat("TermServiceNote:{0},", _paramResult["TermServiceNote"]);
        if (_paramResult.ContainsKey("ConsentDateStart").Equals(true))  _valueCookie.AppendFormat("ConsentDateStart:{0},", _paramResult["ConsentDateStart"]);
        if (_paramResult.ContainsKey("ConsentDateEnd").Equals(true))    _valueCookie.AppendFormat("ConsentDateEnd:{0},", _paramResult["ConsentDateEnd"]);        
        if (_paramResult.ContainsKey("SortOrderBy").Equals(true))       _valueCookie.AppendFormat("SortOrderBy:{0},", _paramResult["SortOrderBy"]);
        if (_paramResult.ContainsKey("SortExpression").Equals(true))    _valueCookie.AppendFormat("SortExpression:{0},", _paramResult["SortExpression"]);
        if (_paramResult.ContainsKey("CurrentPage").Equals(true))       _valueCookie.AppendFormat("CurrentPage:{0},", _paramResult["CurrentPage"]);
        if (_paramResult.ContainsKey("StartRow").Equals(true))          _valueCookie.AppendFormat("StartRow:{0},", _paramResult["StartRow"]);
        if (_paramResult.ContainsKey("EndRow").Equals(true))            _valueCookie.AppendFormat("EndRow:{0},", _paramResult["EndRow"]);
        if (_paramResult.ContainsKey("RowPerPage").Equals(true))        _valueCookie.AppendFormat("RowPerPage:{0}", _paramResult["RowPerPage"]);

        if (_setCookie.Equals(true)) Util.SetAddCookie(_myParamSearchCookieName, _valueCookie);

        return _paramResult;
    }

    //ฟังก์ชั่นสำหรับแสดงผลการค้นหาข้อมูล แล้วส่งค่ากลับเป็น Dictionary<string, object>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _pageMain      เป็น string รับค่าชื่อหน้าหลัก
    //2. _pageSearch    เป็น string รับค่าชื่อหน้าค้นหา
    //3. _c             เป็น HttpContext รับค่าข้อมูลจาก javascript ที่เรียกใช้งาน    
    public static Dictionary<string, object> GetSearch(string _pageMain, string _pageSearch, HttpContext _c)
    {
        ...
        if (_pageSearch.Equals(PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMLEVEL2VIEWTABLE_MAIN)) _setCookie = false;

        _paramSearch = SetParameterSearch(_pageMain, _c, _setCookie);

        if (_pageSearch.Equals(PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_MAIN))                                _searchResult = HCSStaffMasterDataUtil.HospitalOfHealthCareServiceUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_MASTERDATAREGISTRATIONFORM_MAIN))                                           _searchResult = HCSStaffMasterDataUtil.RegistrationFormUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_MASTERDATAAGENCYREGISTERED_MAIN))                                           _searchResult = HCSStaffMasterDataUtil.AgencyRegisteredUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_DOWNLOADREGISTRATIONFORM_MAIN))                                             _searchResult = HCSStaffDownloadRegistrationFormUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESHEALTHINFORMATION_MAIN))                                         _searchResult = HCSStaffOurServicesUtil.HealthInformationUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMVIEWCHART_MAIN))          _searchResult = HCSStaffOurServicesUtil.StatisticsDownloadHealthCareServiceFormUtil.ViewChartUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMLEVEL1VIEWTABLE_MAIN))    _searchResult = HCSStaffOurServicesUtil.StatisticsDownloadHealthCareServiceFormUtil.ViewTableUtil.GetSearch(_pageSearch, _paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESSTATISTICSDOWNLOADHEALTHCARESERVICEFORMLEVEL2VIEWTABLE_MAIN))    _searchResult = HCSStaffOurServicesUtil.StatisticsDownloadHealthCareServiceFormUtil.ViewTableUtil.GetSearch(_pageSearch, _paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTREGISTRATION_MAIN))                         _searchResult = HCSStaffOurServicesUtil.TermServiceConsentUtil.GetSearch(_paramSearch);
        if (_pageSearch.Equals(PAGE_OURSERVICESTERMSERVICEHCSCONSENTOOCA_MAIN))                                 _searchResult = HCSStaffOurServicesUtil.TermServiceConsentUtil.GetSearch(_paramSearch);
    ...
    public static Dictionary<string, object> SetValueDataRecorded(string _page, string _id)
    {
        ...
        if (_page.Equals(PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_EDIT))  _ds = HCSStaffDB.GetHCSHospital(_id);
        if (_page.Equals(PAGE_MASTERDATAREGISTRATIONFORM_EDIT))             _ds = HCSStaffDB.GetHCSRegistrationForm(_id);
        if (_page.Equals(PAGE_MASTERDATAAGENCYREGISTERED_EDIT))             _ds = HCSStaffDB.GetHCSAgencyRegistered(_id);

        if (_ds.Tables.Count > 0)
        {
            if (_page.Equals(PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_EDIT))  _dataRecorded = HCSStaffMasterDataUtil.HospitalOfHealthCareServiceUtil.SetValueDataRecorded(_dataRecorded, _ds);
            if (_page.Equals(PAGE_MASTERDATAREGISTRATIONFORM_EDIT))             _dataRecorded = HCSStaffMasterDataUtil.RegistrationFormUtil.SetValueDataRecorded(_dataRecorded, _ds);
            if (_page.Equals(PAGE_MASTERDATAAGENCYREGISTERED_EDIT))             _dataRecorded = HCSStaffMasterDataUtil.AgencyRegisteredUtil.SetValueDataRecorded(_dataRecorded, _ds);
        }

        _ds.Dispose();

        if (_page.Equals(PAGE_MASTERDATAHOSPITALOFHEALTHCARESERVICE_EDIT))  _valueDataRecordedResult.Add(("DataRecorded" + SUBJECT_SECTION_HOSPITALOFHEALTHCARESERVICE), _dataRecorded);
        if (_page.Equals(PAGE_MASTERDATAREGISTRATIONFORM_EDIT))             _valueDataRecordedResult.Add(("DataRecorded" + SUBJECT_SECTION_REGISTRATIONFORM), _dataRecorded);
        if (_page.Equals(PAGE_MASTERDATAAGENCYREGISTERED_EDIT))             _valueDataRecordedResult.Add(("DataRecorded" + SUBJECT_SECTION_AGENCYREGISTERED), _dataRecorded);

        return _valueDataRecordedResult;               
    }    

    //ฟังก์ชั่นสำหรับกำหนดคอลัมภ์ให้กับตารางเก็บข้อมูล แล้วส่งค่ากลับเป็น DataTable
    //โดยมีพารามิเตอร์ดังนี้
    //1. _page  เป็น string รับค่าชื่อหน้า 
