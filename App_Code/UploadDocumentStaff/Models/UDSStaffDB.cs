...
{
    //ฟังก์ชั่นสำหรับดึงข้อความจากไฟล์ข้อความ แล้วส่งค่ากลับเป็น List<string>
    //โดยมีพารามิเตอร์ดังนี้
    //1. _lang      เป็น string รับค่าภาษาที่ต้องการให้แสดง
    //2. _fileName  เป็น string รับค่าชื่อไฟล์ข้อความ
    ...
    //ฟังก์ชั่นสำหรับค้นหาข้อมูลนักศึกษาที่อัพโหลดเอกสารจากฐานข้อมูล แล้วส่งค่ากลับเป็น DataSet
    //โดยมีพารามิเตอร์ดังนี้
    ...
    //ฟังก์ชั่นสำหรับดึงข้อมูลประเทศเฉพาะที่มีการส่งระเบียนแสดงผลการเรียนจากฐานข้อมูล แล้วส่งค่ากลับเป็น DataSet
    //โดยมีพารามิเตอร์ดังนี้
    ...
    //ฟังก์ชั่นสำหรับดึงข้อมูลสถานที่หรือจังหวัดเฉพาะที่มีการส่งระเบียนแสดงผลการเรียนจากฐานข้อมูล แล้วส่งค่ากลับเป็น DataSet
    //โดยมีพารามิเตอร์ดังนี้
    //1. _paramSearch   เป็น Dictionary<string, object> รับค่าพารามิเตอร์ที่ใช้ค้นหาข้อมูล
    ...
    //ฟังก์ชั่นสำหรับดึงข้อมูลสถานที่หรืออำเภอเฉพาะที่มีการส่งระเบียนแสดงผลการเรียนจากฐานข้อมูล แล้วส่งค่ากลับเป็น DataSet
    //โดยมีพารามิเตอร์ดังนี้
    //1. _paramSearch   เป็น Dictionary<string, object> รับค่าพารามิเตอร์ที่ใช้ค้นหาข้อมูล
