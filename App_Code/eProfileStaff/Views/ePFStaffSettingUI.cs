...
public class ePFStaffSettingUI
{
    public class AccesstotheSystemUI
    {
        private static string _idSectionEdit = ePFStaffUtil.ID_SECTION_SETTINGACCESSTOTHESYSTEM_EDIT.ToLower();
        ...
        public static StringBuilder GetSection(Dictionary<string, object> _infoLogin, string _section, string _sectionAction, string _id)
        {
            ...
            {
                case "EDIT":
                    _html = SectionAddUpdateUI.SectionEditUI.GetMain(_infoLogin, _id);
                    break;
            }
        ...
        public class SectionAddUpdateUI
        {
            ...
            public class SectionEditUI
            {
                public static StringBuilder GetMain(Dictionary<string, object> _infoLogin, string _id)
                {
                    ...
                    Dictionary<string, object> _infoDataResult = ePFStaffUtil.GetInfoData(ePFStaffUtil.PAGE_SETTINGACCESSTOTHESYSTEM_EDIT, _infoData);
                    StringBuilder _html = new StringBuilder();

                    _idSectionAddUpdate = _idSectionEdit;

                    _html.AppendLine(ePFStaffUI.GetInfoBar(_infoDataResult, true).ToString());
                    _html.AppendLine(SectionAddUpdateUI.GetValueDataRecorded(ePFStaffUtil.SetValueDataRecorded(ePFStaffUtil.PAGE_SETTINGACCESSTOTHESYSTEM_EDIT, _id)).ToString());
            ...
            {
                StringBuilder _html = new StringBuilder();
                Dictionary<string, object> _dataRecorded = (_valueDataRecorded != null ? (Dictionary<string, object>)_valueDataRecorded["DataRecorded" + ePFStaffUtil.SUBJECT_SECTION_ACCESSTOTHESYSTEM] : null);
            ...
            public static StringBuilder GetMain(Dictionary<string, object> _infoLogin)
            {
                ...
                _contentTemp.AppendFormat("     <span><div id='{0}-starthour-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxHour(_idSectionAddUpdate + "-starthour"));
                _contentTemp.AppendLine("       <span class='th-label'>:</span>");
                _contentTemp.AppendFormat("     <span><div id='{0}-startminute-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxMinute(_idSectionAddUpdate + "-startminute"));
                _contentTemp.AppendLine("       <span class='th-label'>:</span>");
                _contentTemp.AppendFormat("     <span><div id='{0}-startsecond-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxSecond(_idSectionAddUpdate + "-startsecond"));
                ...
                _contentTemp.AppendLine("   <div class='contentbody-left'>");
                _contentTemp.AppendFormat("     <span><div id='{0}-endhour-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxHour(_idSectionAddUpdate + "-endhour"));
                _contentTemp.AppendLine("       <span class='th-label'>:</span>");
                _contentTemp.AppendFormat("     <span><div id='{0}-endminute-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxMinute(_idSectionAddUpdate + "-endminute"));
                _contentTemp.AppendLine("       <span class='th-label'>:</span>");
                _contentTemp.AppendFormat("     <span><div id='{0}-endsecond-combobox'>{1}</div></span>", _idSectionAddUpdate, ePFStaffUI.GetComboboxSecond(_idSectionAddUpdate + "-endsecond"));
                _contentTemp.AppendLine("   </div>");
                _contentTemp.AppendLine("</div>");
                _contentTemp.AppendLine("<div class='clear'></div>");
                ...
                _html.AppendLine(               ePFStaffUI.GetFrmColumn(_contentFrmColumn["StartDate"]).ToString());
                _html.AppendLine(               ePFStaffUI.GetFrmColumn(_contentFrmColumn["EndDate"]).ToString());
                ...
                _html.AppendLine(               ePFStaffUI.GetFrmColumn(_contentFrmColumn["FacultyProgram"]).ToString());
