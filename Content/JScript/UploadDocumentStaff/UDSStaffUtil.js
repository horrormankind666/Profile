...
var UDSStaffUtil = {
    ...
    initMenuBar: function () {
        ...
        $(function () {
            $(".menubar .link-click").click(function () {
                ...
                if (_idLink == ("link-" + _this.subjectSectionUploadSubmitDocument.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageUploadSubmitDocumentMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionApproveDocument.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageApproveDocumentMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesDocumentStatusStudent.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesDocumentStatusStudentMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesExportProfilePictureApproved.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesExportProfilePictureApprovedMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesExportStudentRecordsInformationForSmartCard.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesExportStudentRecordsInformationForSmartCardMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesCopyProfilePictureApprovedtotheStore.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesCopyProfilePictureApprovedtotheStoreMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesAuditTranscriptApproved.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesAuditTranscriptApprovedMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesExportSaveAuditTranscriptApproved.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesExportSaveAuditTranscriptApprovedMain)
                    });
        ...
        $(function () {
            $(".infobar .link-click").click(function () {
                ...
                if (_idLink == ("save-" + _this.pageSettingAccesstotheSystemEdit.toLowerCase()))
                    Util.tut.tst.confirmSave({
                        page: _this.pageSettingAccesstotheSystemEdit
                    });
                ...
                if (_idLink == ("search-" + _this.pageUploadSubmitDocumentMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("upload-" + _this.pageUploadSubmitDocumentMain.toLowerCase()))
                    _this.getUploadSubmitDocument({
                        data: $("#" + Util.tut.tus.idSectionPreview + "-personid-hidden").val()
                    });

                if (_idLink == ("profile-" + _this.pageUploadSubmitDocumentMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tus.idSectionPreview + "-personid-hidden").val()
                    });

                if (_idLink == ("home-" + _this.pageUploadSubmitDocumentAddUpdate.toLowerCase()))
                    Util.getPage();

                if (_idLink == ("profile-" + _this.pageUploadSubmitDocumentAddUpdate.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tus.sectionAddUpdate.studentrecords.idSectionAddUpdate + "-personid-hidden").val()
                    });

                if (_idLink == ("close-" + _this.pageUploadSubmitDocumentAddUpdate.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageUploadSubmitDocumentMain)
                    });

                if (_idLink == ("search-" + _this.pageApproveDocumentMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageApproveDocumentMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tap.idSectionEdit + "-personid-hidden").val()
                    });

                if (_idLink == ("search-" + _this.pageOurServicesDocumentStatusStudentMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageOurServicesDocumentStatusStudentMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tos.documentstatusstudent.viewtable.idSectionLevel1Preview + "-personid-hidden").val()
                    });

                if (_idLink == ("search-" + _this.pageOurServicesExportProfilePictureApprovedMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageOurServicesExportProfilePictureApprovedMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tos.exportprofilepictureapproved.idSectionPreview + "-personid-hidden").val()
                    });

                if (_idLink == ("search-" + _this.pageOurServicesExportStudentRecordsInformationForSmartCardMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageOurServicesExportStudentRecordsInformationForSmartCardMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tos.exportstudentrecordsinformationforsmartcard.idSectionPreview + "-personid-hidden").val()
                    });

                if (_idLink == ("search-" + _this.pageOurServicesCopyProfilePictureApprovedtotheStoreMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageOurServicesCopyProfilePictureApprovedtotheStoreMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tos.copyprofilepictureapprovedtothestore.idSectionPreview + "-personid-hidden").val()
                    });

                if (_idLink == ("search-" + _this.pageOurServicesAuditTranscriptApprovedMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("search-" + _this.pageOurServicesExportSaveAuditTranscriptApprovedMain.toLowerCase()))
                    Util.setSearchShow();

                if (_idLink == ("profile-" + _this.pageOurServicesExportSaveAuditTranscriptApprovedMain.toLowerCase()))
                    Util.getStudentCV({
                        data: $("#" + Util.tut.tos.exportsaveaudittranscriptapproved.idSectionPreview + "-personid-hidden").val()
                    });
            });
        });
    },
    getErrorMsg: function (_param) {
        ...
        if (_error == false && _status == "Y002") {
            _error = true;
            _msgTH = "เชื่อมต่อเครื่องแม่ข่ายไม่สำเร็จ";
            _msgEN = "Not connect server.";
        }
    ...
    setSelectCombobox: function (_param) {
        ...
        if (_param["id"] == ("#" + this.idSectionUploadSubmitDocumentMain.toLowerCase() + "-rowperpage") ||
            ...
            if (_param["id"] == ("#" + this.idSectionUploadSubmitDocumentMain.toLowerCase() + "-rowperpage"))
                _page = this.pageUploadSubmitDocumentMain;

            if (_param["id"] == ("#" + this.idSectionApproveDocumentMain.toLowerCase() + "-rowperpage"))
                _page = this.pageApproveDocumentMain;

            if (_param["id"] == ("#" + this.idSectionOurServicesDocumentStatusStudentLevel1ViewTableMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesDocumentStatusStudentMain;

            if (_param["id"] == ("#" + this.idSectionOurServicesExportProfilePictureApprovedMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesExportProfilePictureApprovedMain; 

            if (_param["id"] == ("#" + this.idSectionOurServicesExportStudentRecordsInformationForSmartCardMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesExportStudentRecordsInformationForSmartCardMain

            if (_param["id"] == ("#" + this.idSectionOurServicesCopyProfilePictureApprovedtotheStoreMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesCopyProfilePictureApprovedtotheStoreMain;

            if (_param["id"] == ("#" + this.idSectionOurServicesExportSaveAuditTranscriptApprovedMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesExportSaveAuditTranscriptApprovedMain;
    ...
    getFrmPreviewDocument: function (_param, _callBackFunc) {
        ...
        if (_param["data"].length > 0) {
            ...
            if ($("#" + _param["idPreview"] + "-personid-hidden").length > 0)
                $("#" + _param["idPreview"] + "-personid-hidden").val(_param["data"]);
    ...
    initViewDocument: function (_param) {
        ...
        $("#" + _idContent + "-form .picture-content").hover(
            function () {
                ...
                if (_hasClass == true && $("#" + _idContent + "-form img").is(":visible"))
                    $("#" + _idContent + "-form .picture-zoom").show();
            },
            function () {
                _hasClass = ($(this).hasClass(_param["section"].toLowerCase() + "-content") ? true : _hasClass);

                if (_hasClass == true && $("#" + _idContent + "-form img").is(":visible"))
                    $("#" + _idContent + "-form .picture-zoom").hide();
            }
        );
    ...
    getDialogFormOnClick: function () {
        ...
        $(".link-" + _this.subjectSectionMeaningofAdmissionType.toLowerCase() + ", " +
          ...
          ".link-" + _this.subjectSectionMeaningOfAuditedStatus.toLowerCase()).click(function () {
            ...
            if ($(this).hasClass("link-" + _this.subjectSectionMeaningOfSubmittedStatus.toLowerCase()) == true)
                _page = _this.pageMeaningOfSubmittedStatusMain;

            if ($(this).hasClass("link-" + _this.subjectSectionMeaningOfApprovalStatus.toLowerCase()) == true)
                _page = _this.pageMeaningOfApprovalStatusMain;

            if ($(this).hasClass("link-" + _this.subjectSectionMeaningOfAuditedStatus.toLowerCase()) == true)
                _page = _this.pageMeaningOfAuditedStatusMain;
