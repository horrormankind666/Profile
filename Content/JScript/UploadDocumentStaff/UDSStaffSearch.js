...
var UDSStaffSearch = {
    ...
    clearTable: function () {
        ...
        if (_page == Util.tut.pageOurServicesDocumentStatusStudentMain) {
            ...
            if (_page == Util.tut.pageOurServicesDocumentStatusStudentViewTableMain)
                _page = Util.tut.pageOurServicesDocumentStatusStudentLevel1ViewTableMain;
    ...
    resetSearch: function (_param) {
        ...
        if (_param["page"] == Util.tut.pageUploadSubmitDocumentMain)
            _this = this.uploadsubmitdocument;

        if (_param["page"] == Util.tut.pageApproveDocumentMain)
            _this = this.approvedocument;

        if (_param["page"] == Util.tut.pageOurServicesDocumentStatusStudentMain)
            _this = this.ourservices.documentstatusstudent;

        if (_param["page"] == Util.tut.pageOurServicesExportProfilePictureApprovedMain)
            _this = this.ourservices.exportprofilepictureapproved;

        if (_param["page"] == Util.tut.pageOurServicesExportStudentRecordsInformationForSmartCardMain)
            _this = this.ourservices.exportstudentrecordsinformationforsmartcard;

        if (_param["page"] == Util.tut.pageOurServicesCopyProfilePictureApprovedtotheStoreMain)
            _this = this.ourservices.copyprofilepictureapprovedtothestore;

        if (_param["page"] == Util.tut.pageOurServicesAuditTranscriptApprovedMain)
            _this = this.ourservices.audittranscriptapproved;

        if (_param["page"] == Util.tut.pageOurServicesExportSaveAuditTranscriptApprovedMain)
            _this = this.ourservices.exportsaveaudittranscriptapproved;
    ...
    getSearch: function(_param) {
        ...
        if (_param["page"] == Util.tut.pageOurServicesDocumentStatusStudentMain ||
            ...
            if (_param["page"] == Util.tut.pageOurServicesDocumentStatusStudentMain)
                _this = Util.tut.tos.documentstatusstudent;

            if (_param["page"] == Util.tut.pageOurServicesAuditTranscriptApprovedMain)
                _this = Util.tut.tos.audittranscriptapproved;

            _idContent = Util.getTabActiveOnTabbar({
                id: (_this.idSectionMain + "-viewsdisplay")
            });
            _param["page"] = $("#" + _idContent).attr("alt");

            if (_param["page"] == Util.tut.pageOurServicesDocumentStatusStudentViewTableMain)
                _param["page"] = Util.tut.pageOurServicesDocumentStatusStudentLevel1ViewTableMain;

            if (_param["page"] == Util.tut.pageOurServicesAuditTranscriptApprovedViewTableMain)
                _param["page"] = Util.tut.pageOurServicesAuditTranscriptApprovedLevel1ViewTableMain;
        }
    ...
    actionSearch: function (_param) {
        ...
        Util.actionSearch({
            ...
            if (_param["pageSearch"] == Util.tut.pageUploadSubmitDocumentMain)
                Util.tut.tus.sectionMain.initTable();

            if (_param["pageSearch"] == Util.tut.pageApproveDocumentMain)
                Util.tut.tap.sectionMain.initTable();

            if (_param["pageSearch"] == Util.tut.pageOurServicesDocumentStatusStudentLevel1ViewTableMain)
                Util.tut.tos.documentstatusstudent.viewtable.sectionMain.initTable({
                    page: _param["pageSearch"]
                });

            if (_param["pageSearch"] == Util.tut.pageOurServicesExportProfilePictureApprovedMain)
                Util.tut.tos.exportprofilepictureapproved.sectionMain.initTable();

            if (_param["pageSearch"] == Util.tut.pageOurServicesExportStudentRecordsInformationForSmartCardMain)
                Util.tut.tos.exportstudentrecordsinformationforsmartcard.sectionMain.initTable();

            if (_param["pageSearch"] == Util.tut.pageOurServicesCopyProfilePictureApprovedtotheStoreMain)
            ...
            if (_param["pageSearch"] == Util.tut.pageOurServicesExportSaveAuditTranscriptApprovedMain)
    ...
    uploadsubmitdocument: {
        ...
        validateSearch: function () {
            ...
            if (Util.comboboxGetValue("#" + this.idSectionSearch + "-documentupload") == "0") {
                _error[_i] = "กรุณาเลือกเอกสารอัพโหลด;Please select document upload.;";
                _i++;
            }
    ...
    ourservices: {
        ...
        exportsaveaudittranscriptapproved: {
            ...
            validateSearch: function () {
                ...
                if ($("#" + this.idSectionSearch + "-sentdatestartaudit").val().length > 0 && $("#" + this.idSectionSearch + "-sentdateendaudit").val().length == 0) {
                    _error[_i] = "กรุณาใส่วันที่ส่งระเบียนแสดงผลการเรียนตรวจสอบให้ครบถ้วน;Please enter sent date transcript audit in the form completely.;";
                    _i++;
                }
