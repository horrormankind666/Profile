...
var ePFStaffSetting = {
    accesstothesystem: {
        idSectionEdit: ePFStaffUtil.idSectionSettingAccesstotheSystemEdit.toLowerCase(),
        sectionAddUpdate: {
            idSectionAddUpdate: "",
            sectionEdit: {
                initMain: function () {
            ...
            validateSave: function () {
                ...
                if ($("#" + _this3.idSectionAddUpdate + "-startdate").val().length == 0) {
                    _error[_i] = "กรุณาใส่วันทำการเริ่มต้น;Please enter office hour start date.;" + _this3.idSectionAddUpdate + "-startdatetime-content";
                    _i++;
                }

                if ($("#" + _this3.idSectionAddUpdate + "-enddate").val().length == 0) {
                    _error[_i] = "กรุณาใส่วันทำการสิ้นสุด;Please enter office hour end date.;" + _this3.idSectionAddUpdate + "-enddatetime-content";
                    _i++;
                }
                ...
                if (($("#" + _this3.idSectionAddUpdate + "-startdate").val() == $("#" + _this3.idSectionAddUpdate + "-enddate").val())) {
                    ...
                    if ((_startHour > _endHour) || (_startHour == _endHour && _startMinute > _endMinute) || (_startHour == _endHour && _startMinute == _endMinute && _startSecond > _endSecond)) {
                        _error[_i] = "กรุณาใส่เวลาทำการให้ถูกต้อง;Invalid office hour.;" + _this3.idSectionAddUpdate + "-startdatetime-content";
                        _i++;
                    }
                }
    ...
    validateSave: function (_param) {
        ...
        if (_param["page"] == Util.tut.pageSettingAccesstotheSystemEdit)
            _this = this.accesstothesystem.sectionAddUpdate;
