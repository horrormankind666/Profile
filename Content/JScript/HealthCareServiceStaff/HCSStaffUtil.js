...
var HCSStaffUtil = {
    ...
    initMenuBar: function () {
        ...
        $(function () {
            $(".menubar .link-click").click(function () {
                ...
                if (_idLink == ("link-" + _this.subjectSectionMasterDataHospitalOfHealthCareService.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageMasterDataHospitalOfHealthCareServiceMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionMasterDataRegistrationForm.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageMasterDataRegistrationFormMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionMasterDataAgencyRegistered.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageMasterDataAgencyRegisteredMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionDownloadRegistrationForm.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageDownloadRegistrationFormMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesHealthInformation.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesHealthInformationMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesStatisticsDownloadHealthCareServiceForm.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesStatisticsDownloadHealthCareServiceFormMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesTermServiceHCSConsentRegistration.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesTermServiceHCSConsentRegistrationMain)
                    });

                if (_idLink == ("link-" + _this.subjectSectionOurServicesTermServiceHCSConsentOOCA.toLowerCase()))
                    Util.gotoPage({
                        page: ("index.aspx?p=" + _this.pageOurServicesTermServiceHCSConsentOOCAMain)
                    });
    ...
    initInfoBar: function () {
        ...
        $(function () {
            $(".infobar .link-click").click(function () {
                ...
                if (_idLink == ("new-" + _this.pageMasterDataHospitalOfHealthCareServiceMain.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataHospitalOfHealthCareServiceNew
                    });

                if (_idLink == ("save-" + _this.pageMasterDataHospitalOfHealthCareServiceNew.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataHospitalOfHealthCareServiceNew
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataHospitalOfHealthCareServiceNew.toLowerCase()))
                    Util.tut.tmd.hospitalofhealthcareservice.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataHospitalOfHealthCareServiceNew.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataHospitalOfHealthCareServiceMain
                    });

                if (_idLink == ("save-" + _this.pageMasterDataHospitalOfHealthCareServiceEdit.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataHospitalOfHealthCareServiceEdit
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataHospitalOfHealthCareServiceEdit.toLowerCase()))
                    Util.tut.tmd.hospitalofhealthcareservice.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataHospitalOfHealthCareServiceEdit.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataHospitalOfHealthCareServiceMain
                    });

                if (_idLink == ("new-" + _this.pageMasterDataRegistrationFormMain.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataRegistrationFormNew
                    });

                if (_idLink == ("save-" + _this.pageMasterDataRegistrationFormNew.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataRegistrationFormNew
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataRegistrationFormNew.toLowerCase()))
                    Util.tut.tmd.registrationform.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataRegistrationFormNew.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataRegistrationFormMain
                    });

                if (_idLink == ("save-" + _this.pageMasterDataRegistrationFormEdit.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataRegistrationFormEdit
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataRegistrationFormEdit.toLowerCase()))
                    Util.tut.tmd.registrationform.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataRegistrationFormEdit.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataRegistrationFormMain
                    });

                if (_idLink == ("new-" + _this.pageMasterDataAgencyRegisteredMain.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataAgencyRegisteredNew
                    });

                if (_idLink == ("save-" + _this.pageMasterDataAgencyRegisteredNew.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataAgencyRegisteredNew
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataAgencyRegisteredNew.toLowerCase()))
                    Util.tut.tmd.agencyregistered.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataAgencyRegisteredNew.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataAgencyRegisteredMain
                    });

                if (_idLink == ("save-" + _this.pageMasterDataAgencyRegisteredEdit.toLowerCase()))
                    Util.tut.tmd.confirmSave({
                        page: _this.pageMasterDataAgencyRegisteredEdit
                    });

                if (_idLink == ("undo-" + _this.pageMasterDataAgencyRegisteredEdit.toLowerCase()))
                    Util.tut.tmd.agencyregistered.sectionAddUpdate.resetMain();

                if (_idLink == ("close-" + _this.pageMasterDataAgencyRegisteredEdit.toLowerCase()))
                    Util.gotoPage({
                        page: "index.aspx?p=" + _this.pageMasterDataAgencyRegisteredMain
                    });
            });
    ...
    getErrorMsg: function (_param) {
        ...
        if (_error == false && _status == "Y004") {
            _error = true;
            _msgTH = "บันทึกข้อมูลไม่สำเร็จ เนื่องจากข้อมูลบางส่วนมีอยู่แล้ว";
            _msgEN = "Save was not successful, duplicate data.";
        }

        if (_error == false && _status == "Y005") {
            _error = true;
            _msgTH = "บันทึกข้อมูลไม่สำเร็จ เนื่องจากไม่พบข้อมูล";
            _msgEN = "Save was not successful, data not found.";
        }
    ...
    setSelectCombobox: function (_param) {
        ...
        if (_param["id"] == ("#" + this.idSectionMasterDataHospitalOfHealthCareServiceMain.toLowerCase() + "-rowperpage") ||
            ...
            if (_param["id"] == ("#" + this.idSectionMasterDataHospitalOfHealthCareServiceMain.toLowerCase() + "-rowperpage"))
                _page = this.pageMasterDataHospitalOfHealthCareServiceMain;

            if (_param["id"] == ("#" + this.idSectionMasterDataRegistrationFormMain.toLowerCase() + "-rowperpage"))
                _page = this.pageMasterDataRegistrationFormMain;

            if (_param["id"] == ("#" + this.idSectionMasterDataAgencyRegisteredMain.toLowerCase() + "-rowperpage"))
                _page = this.pageMasterDataAgencyRegisteredMain;

            if (_param["id"] == ("#" + this.idSectionDownloadRegistrationFormMain.toLowerCase() + "-rowperpage"))
                _page = this.pageDownloadRegistrationFormMain;

            if (_param["id"] == ("#" + this.idSectionOurServicesHealthInformationMain.toLowerCase() + "-rowperpage"))
                _page = this.pageOurServicesHealthInformationMain;

            if (_param["id"] == ("#" + this.idSectionOurServicesTermServiceHCSConsentMain.toLowerCase() + "-rowperpage"))
                _page = HCSStaffOurServices.termservicehcsconsent.pageMain;
    ...
    getDialogFormOnClick: function () {
        ...
        $(".link-" + _this.subjectSectionMeaningofAdmissionType.toLowerCase() + ", " +
          ...
          ".link-" + _this.subjectSectionMeaningofHealthCareServiceForm.toLowerCase()).click(function () {
            ...
            if ($(this).hasClass("link-" + _this.subjectSectionMeaningofHealthCareServiceForm.toLowerCase()) == true)
                _page = _this.pageMeaningofHealthCareServiceForm;            
