...
var HCSUtil = {
    ...
    getErrorMsg: function (_param) {
        ...
        if (_error == false && _status == "Y020") {
            _error = true;
            _msgTH = "นักศึกษาไม่ได้สังกัดในส่วนงานที่ขึ้นทะเบียน";
            _msgEN = "Student not be under agency registered.";
        }
...
var HCSDownloadRegistrationForm = {
    ...
    sectionMain: {
        initMain: function () {
            ...
            if ($("#" + _this.idSectionMain + "-slide").length > 0)
                setInterval("Util.tut.swapImages({ id: '" + _this.idSectionMain + "-slide' })", 1000);
