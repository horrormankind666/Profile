...
Create date : <๐๘/๐๖/๒๕๕๘>
Modify date : <๒๗/๐๘/๒๕๕๘>
...
public partial class UDSUploadFile : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int _maxHeight = 0;
        float _ratio = 0;
        Dictionary<string, object> _fileAttribute = UDSUploadSubmitDocumentUtil.GetFileAttribute(_section);
        ...
        try
        {
            ...
            if (_error.Equals(0))
            {
                ...
                _error = Util.RemoveMultipleFiles(UDSUtil._myFileUploadTempPath, ("*" + _personId + _fileAttribute["Section"].ToString() + "*.*"));
                ...
                _sourceFile = Server.MapPath(UDSUtil._myFileUploadTempPath + "/" + _fileName + _fileExtension.ToLower());
